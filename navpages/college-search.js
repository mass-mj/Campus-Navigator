...
function sortColleges(sortOption) {
    ...
    collegeCards.sort((a, b) => {
        switch(sortOption) {
            ...
            case 'tuition-low':
                return parseInt(a.getAttribute('data-tuition')) - parseInt(b.getAttribute('data-tuition'));
            case 'tuition-high':
                return parseInt(b.getAttribute('data-tuition')) - parseInt(a.getAttribute('data-tuition'));
            case 'acceptance':
...
function applyAdvancedFilters(locations, programs, types, maxTuition) {
    ...
    collegeCards.forEach(card => {
        // Get card data
        const cardCategory = card.getAttribute('data-category').toLowerCase();
        const cardTuition = parseInt(card.getAttribute('data-tuition'));
